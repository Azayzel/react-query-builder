...
class QueryBuilder extends React.Component {
  constructor(props) {
    ...
    this.handleEIUCheck = this.handleEIUCheck.bind(this);
  ...
  handleEIUCheck(e) {
    let excludeEIU = this.state.excludeEIU ? false : true;
    let set = this.state.reportSet;

    // Re-Generate Query String
    set.generateQueryString(excludeEIU);
    ...
    // Set state of component
    this.setState({ reportSet: set, excludeEIU: excludeEIU });
  };
    ...
    return (
      <div className="uk-container uk-container-expand">
        <div className="uk-width-1-1 uk-margin-bottom">
          ...
          <h3 className="uk-float-right">
            <a class="uk-link-heading" href="#" onClick={this.resetReport}>
              Reset Report
            </a>
          </h3>
        </div>
        <div className="uk-width-1-1" id="reportsTable">
          <div>
            <p className="uk-text-meta">
              Query Options{" "}
              <i className="uk-margin-small-left" uk-icon="icon: cog" />{" "}
            </p>
        ...
        />
        <p className="uk-text-meta"> * By default, we exclude all 'EIU' data</p>
        <div className="uk-margin uk-grid-small uk-child-width-auto uk-grid">
          <label>
            <input
              className="uk-checkbox"
              type="checkbox"
              checked={this.state.excludeEIU}
              onClick={this.handleEIUCheck}
            />{" "}
            Exclude EIU Data
          </label>
        </div>
        ...
        {!this.state.isCreatingReport ? (
          <div className="uk-container uk-container-expand uk-margin-top uk-animation-slide-right">
            <div className="uk-width-1-1">
              {this.props.HideExecuteButton ? null : (
                <button
                  className="uk-button uk-button-primary"
